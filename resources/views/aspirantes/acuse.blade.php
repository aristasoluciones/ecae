...
<table style="table-layout: fixed; width: 726px; margin-bottom: 10pt;";>
    ...
    <table class="enmedio">
        ...
        <tbody>
            <tr>
                <td class="gris" style="width:18.3%;">
                    Fecha de recepción</td>
                <td class="rosa" style="width: 23%; text-align: center;">&nbsp;
                </td>
                <td class="gris" style="width: 10%; text-align: center;">
                    Número de convocatoria</td>
                <td class="rosa" style="width: 23%; text-align: center;">&nbsp;
                </td>
                <td class="gris" style="width: 13%; text-align: center;">
                    Folio de la persona aspirante</td>
                <td class="rosa" style="width: 20%; text-align: center;">
                    &nbsp;</td>
            </tr>
        </tbody>
        </tbody>
    ...
    <table class="enmedio">
        ...
        <tbody>
            <tr>
                <td class="blanco" style="width: 33.33%; text-align: center;">
                    Primer Apellido </td>
                <td class="blanco" style="width: 33.33%; text-align: center;">
                    Segundo Apellido </td>
                <td class="blanco" style="width: 33.33%; text-align: center;">
    ...
    <table class="enmedio">
        ...
        <tbody>
            <tr>
                <td class="blanco" style="width: 10%; text-align: center;">Día
                </td>
                <td class="blanco" style="width: 10%; text-align: center;">Mes
                </td>
                <td class="blanco" style="width: 10%; text-align: center;">Año
                </td>
    ...
    <table class="enmedio">
        ...
        <tbody>
            <tr>
                <td class="blanco" style="width: 65%; text-align: center;">
                    Calle, número exterior, número interior</td>
                <td class="blanco" style="width: 35%; text-align: center;">
                    Colonia</td>
            </tr>
        </tbody>
        </tbody>
    ...
    <table class="final">
        ...
        <tbody>
            <tr>
                <td class="blanco" style="width: 50%; text-align: center;">
                    &nbsp;</td>
                <td class="blanco" style="width: 25%; text-align: center;">
                    Teléfono fijo</td>
                <td class="blanco" style="width: 25%; text-align: center;">
                    Teléfono Celular</td>
            </tr>
    ...
    <table>
        ...
        <tbody>
            <tr>
                <td class="blanco" style="width: 100%; text-align: left;">*LAS
    ...
    <table style="border: #AD84C6 solid; margin-bottom: 10pt; width: 100%;">
        ...
        <tbody>
            <tr>
                <td class="rosa" style="width: 60%; text-align: left;">
                ...
                <td class="rosa" style="width: 40%; text-align: center;">DECLARO
                    <br>
    ...
    <table style="border: #AD84C6 solid; width: 100%;">
        ...
        <tbody>
            <tr>
                <td style="border: #AD84C6 solid; width: 10%;">&nbsp;</td>
                <td class="blanco"
