<div class="row">
    <div class="col-12 col-md-12 col-sm-12">
        <div class="btn-group-toggle d-flex flex-row justify-content-end">
            <button class="btn btn-success m-1"><i class="fa fa-check-circle"></i></button>
            <button class="btn btn-warning m-1"><i class="fa fa-save"></i></button>
        </div>
    </div>
