...
<body>
    ...
    <tr>
        <th></th>
        <th></th>
        <th colspan="4" style="text-align: center; font-size: 13px">Cuadro de calificación  de entrevista SEL y CAEL para el Proceso Electoral Local Ordinario 2024</th>
        <th></th>
        <th></th>
    <tr>
        <th></th>
        <th></th>
        <th colspan="4" style="text-align: center; font-size: 13px">Consejo Municipal Electoral : <strong>{{ !$consejo ? 'Todos los consejos' : $consejo }}</strong></th>
        <th></th>
        <th></th>
    </tr>
    <tr>
