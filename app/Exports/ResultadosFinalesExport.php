...
class ResultadosFinalesExport implements FromView, ShouldAutoSize,WithColumnWidths,WithDrawings,WithEvents,WithStyles
{
    ...
    */
    ...
    {
        return view('exports.resultados_finales',[
            'rows' => $this->rows,
